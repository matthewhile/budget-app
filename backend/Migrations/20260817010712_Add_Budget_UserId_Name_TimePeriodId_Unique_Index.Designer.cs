...
namespace BudgetApp.Migrations
{
    ...
    [Migration("20260817010712_Add_Budget_UserId_Name_TimePeriodId_Unique_Index")]
    partial class Add_Budget_UserId_Name_TimePeriodId_Unique_Index
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetApp.Models.Budget", b =>
                {
                    ...
                    b.HasIndex("UserId", "Name", "TimePeriodId")
                        .IsUnique();

                    b.ToTable("Budgets");
                });

            modelBuilder.Entity("BudgetApp.Models.DefaultBudget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
